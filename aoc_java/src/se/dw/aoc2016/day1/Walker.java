...
public class Walker {
  ...
  private void move(int distance) {
    ...
    // Vertical movement
    if (orientation == NORTH) coordinates[0] += distance;
    else if (orientation == SOUTH) coordinates[0] -= distance;
    // Horizontal movement
    else if (orientation == EAST) coordinates[1] += distance;
    else if (orientation == WEST) coordinates[1] -= distance;
  }
