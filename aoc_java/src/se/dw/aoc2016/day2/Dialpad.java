...
public class Dialpad {
  ...
  public void moveUp() {
    ...
    if (dialcoordinate[Y] > 0) dialcoordinate[Y]--;
  }

  public void moveDown() {
    if (dialcoordinate[Y] < 2) dialcoordinate[Y]++;
  }

  public void moveLeft() {
    if (dialcoordinate[X] > 0) dialcoordinate[X]--;
  }

  public void moveRight() {
    if (dialcoordinate[X] < 2) dialcoordinate[X]++;
  }
}
