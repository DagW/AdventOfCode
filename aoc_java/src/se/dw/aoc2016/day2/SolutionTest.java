...
public class SolutionTest {
  ...
  public static final String input1 = "ULDRULRDULDRD";
  public static final String input2 = "UUUUUUU";
  public static final String input3 = "RURURU";
  public static final String input4 = "DLDLDLDL";
